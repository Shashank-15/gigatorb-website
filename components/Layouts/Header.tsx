        ...
        <header className={`sticky top-0 z-50 bg-black/10 duration-300 ${props.className}`}>
            <div className="container">
                <div className="flex items-center justify-between py-5 lg:py-0">
                    <Link href="/">
                        <img src="\assets\images\gigatorb1new1.png" alt="plurk" className="h-10 w-full" />
                    </Link>
                    <div className="flex items-center">
                        ...
                        <div className={`menus ${showMenu ? 'overflow-y-auto ltr:!right-0 rtl:!left-0' : ''}`}>
                            ...
                            <ul onClick={() => toggleMenu()}>
                                ...
                                <li>
                                    <Link href="/company" className={router.pathname === '/company' ? 'active' : ''}>
                                        Company
                                    </Link>
                                </li>
                                <li className="group relative" onClick={(e) => e.stopPropagation()}>
                                    <Link
                                        href="/services"
                                        className={
                                            router.pathname === '/webDevelopment' ||
                                            router.pathname === '/product' ||
                                            router.pathname === '/devops' ||
                                            router.pathname === '/development-Testing' ||
                                            router.pathname === '/curam' ||
                                            router.pathname === '/ui-ux' ||
                                            router.pathname === '/mobileDevelopment'
                                                ? 'active'
                                                : ''
                                        }
                                    >
                                    ...
                                    <div className="submenu" onClick={() => toggleMenu()}>
                                        ...
                                        <Link href="/mobileDevelopment " className={router.pathname === '/mobileDevelopment' ? 'active' : ''}>
                                            Mobile Development
                                        </Link>
                                        <Link href="/development-Testing" className={router.pathname === '/development-Testing' ? 'active' : ''}>
                                            Development & Testing
                                        </Link>
                                        <Link href="/ui-ux" className={router.pathname === '/ui-ux' ? 'active' : ''}>
                                            UI/UX Design
                                        </Link>
                                        <Link href="/devops" className={router.pathname === '/devops' ? 'active' : ''}>
                                            {' '}
                                            Azure & DevOps{' '}
                                        </Link>
                                        <Link href="/curam" className={router.pathname === '/curam' ? 'active' : ''}>
                                            {' '}
                                            Cúram{' '}
                                        </Link>
                                    </div>
                                ...
                                <li>
                                    <Link href="/gallery" className={router.pathname === '/gallery' || router.pathname === '/gallery' ? 'active' : ''}>
                                        Gallery
                                    </Link>
                                </li>
                  ...
                  search-bar absolute hidden w-0 overflow-hidden bg-black transition-all duration-500 ltr:right-0 rtl:left-0 lg:block`}
                        ...
                        <ul className="flex items-center gap-5 ltr:pr-5 rtl:pl-5 ltr:lg:pl-5 ltr:lg:pr-0 rtl:lg:pl-0 rtl:lg:pr-5">
                            {/* <li>
                                    <button
                                        type="button"
