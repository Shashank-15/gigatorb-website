                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                Customer growth is a crucial focus area. Our company not only aims to acquire new clients but also
                                </p>
                                <Link
                                    href="/services-detail"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                This sets a high standard for our company's aspirations. To be a "top tier" IT company implies bein
                                    </p>
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                Innovation is vital in the rapidly evolving IT industry. Our company seeks to be at the forefront of...</p>
                                <Link
                                    href="/services-detail"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                                >
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                Reliability is key in IT services. Clients rely on Gigatorb to keep their systems running smoothly
                                </p>
                                <Link
                                    href="/services-detail"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                Quality is paramount. Our company is dedicated to producing work of the highest standard. This includes producing error-free software, delivering on time and within budget, and ensuring that products and services meet or exceed industry standards.
                                </p>
                                <Link
                                    href="/services-detail"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                This is a notable and commendable commitment. Our company aims not only to...
                                </p>
                                <Link
                                    href="/services-detail"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
