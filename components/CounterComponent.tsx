                    ...
                    <div className="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-secondary hover:bg-secondary/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            <h4 className="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black">
                                <CountUp start={0} end={15} duration={4} suffix="%"></CountUp>
                            </h4>

                            <span className="font-bold text-black transition dark:text-gray dark:group-hover:text-black">Sales & Marketing</span>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-secondary hover:bg-secondary/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            <h4 className="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black">
                                <CountUp start={0} end={25} duration={4} suffix="%"></CountUp>
                            </h4>
                            <span className="font-bold text-black transition dark:text-gray dark:group-hover:text-black">Design & Strategy </span>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-secondary hover:bg-secondary/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            ...
                            <span className="font-bold text-black transition dark:text-gray dark:group-hover:text-black">Development</span>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-secondary hover:bg-secondary/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            <h4 className="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black">
                                <CountUp start={0} end={20} duration={4} suffix="%"></CountUp>{' '}
                            </h4>
                            <span className="font-bold text-black transition dark:text-gray dark:group-hover:text-black">Testing</span>
                        </div>
                    </div>
                </div>
            </div>
