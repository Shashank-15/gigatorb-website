                                    ...
                                    <div className="py-10 px-5 sm:px-8">
                                        ...
                                        <ul className="space-y-4 pt-10">
                                            <li className="flex gap-3">
                                                ...
                                                <div className="text-sm font-bold sm:text-lg">1311 Freeport Drive, Mississauga, Ontario, Canada, L5C 1S5</div>
                                            </li>
                                ...
                                <div className="mt-10 rounded-[32px] bg-white dark:bg-gray-dark md:grid md:grid-cols-2 lg:mt-0">
                                    ...
                                    <div className="py-10 px-5 sm:px-8">
                                        ...
                                        <svg width="40" height="20" viewBox="0 0 40 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          ...
                                          <rect x="0" y="0" width="40" height="6" fill="#FF9933" />

                                          <rect x="0" y="6" width="40" height="6" fill="white" />

                                           <rect x="0" y="12" width="40" height="6" fill="#138808" />
 
                                           <circle cx="20" cy="9" r="2.5" fill="#000080" />
                                           <circle cx="20" cy="9" r="1.5" fill="white" />
                                           <line x1="20" y1="7" x2="20" y2="11" stroke="#000080" stroke-width="1" />
                                           <line x1="18" y1="9" x2="22" y2="9" stroke="#000080" stroke-width="1" />
                                        </svg>
