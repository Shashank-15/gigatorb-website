...
const Testimonial = ({
    ...
    feedbacks = [
        ...
        },
        {
            ...
            thumbnail: '/assets/images/testimonia.png',
            message:
                "The timely delivery of our website was particularly impressive. Meeting deadlines in the fast-paced world of business is a critical factor, and your team's dedication to ensuring the project was completed as promised demonstrated a high level of professionalism and reliability. This punctuality has allowed us to launch our website as planned, ensuring we stay on track with our overall business strategy.",
        },
        {
            id: 3,
            name: 'Treasured Client',
            ...
            thumbnail: '/assets/images/testimonia.png',
            message:
                "From the initial planning stages to the final delivery, your commitment to meeting our deadlines was evident. The IT solutions provided by your team have not only saved us time and resources but have also improved our overall performance. Your commitment to excellence & dedication to our success is truly commendable",
        },
    ],
    className = '',
}) => {
