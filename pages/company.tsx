                    ...
                    <div className="absolute top-1/2 z-[1] -translate-y-1/2 ltr:left-5 ltr:pr-5 rtl:right-5 rtl:pl-5 ltr:lg:left-[10%] rtl:lg:right-[10%] ">
                        <p className="pb-8 text-sm font-extrabold text-white sm:text-4xl sm:leading-[50px]">
                           ...
                           <ul className='text-lg'>
                            ...
                            <li><span className='text-primary'> Client Satisfaction:</span>  Consistently surpassing expectations for client satisfaction and excellence </li>
                            <li><span className='text-primary'> Innovation:</span>  We are revolutionizing industries through new ideas. </li>
                            <li><span className='text-primary'> Teamwork:</span>  We work together to produce goal-oriented results. </li>
                            <li><span className='text-primary'> Commitment to excellence:</span>  We passionately pursue the highest standard. </li>
                           </ul>
                        </p>
