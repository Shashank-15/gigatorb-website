...
const Contactus = () => {
                    ...
                    <div className="relative z-10 lg:flex">
                        <div className="heading text-center ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <ul className="mt-8 flex items-center justify-center gap-4 lg:justify-start" data-aos="fade-up" data-aos-duration="500">
                                ...
                                <li className="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                                    <Link href="https://www.instagram.com/gigatorbsoftware/?igshid=YmMyMTA2M2Y%3D" className="group">
                                        <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.3" className="transition duration-500 group-hover:opacity-100">
                                                <mask
                                                    id="mask0_553_5772"
                                ...
                                <li className="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                                    <Link href="https://www.linkedin.com/company/gigatorb/mycompany/" className="group">
                                        <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.3" className="transition duration-500 group-hover:opacity-100">
                                                <circle
                                                    cx="33.3459"
  ...
  fill="#C62967"
                        ...
                        <form action="" className="rounded-3xl bg-white px-4 py-12 dark:bg-gray-dark lg:w-2/3 lg:px-8" onSubmit={sendMail}>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    ...
                    <img src="/assets/images/Gallary/canada-map.png" alt="canada-branch" className="w-full rounded-full" />
                </div>
            </section>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    <div className="heading text-center ltr:lg:text-left rtl:lg:text-right">
                        <h4 className="sm:!leading-[50px]">India Branch</h4>
                    </div>
                    <div className="mb-10 grid gap-[30px] md:grid-cols-2 lg:grid-cols-3">
                        <div className="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                            <div className="mb-4 flex items-center gap-2 text-secondary">
                        ...
                        <div className="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h5 className="font-bold text-black dark:text-white lg:text-lg">Indore, India</h5>
                        </div>
                    </div>
                    <img src="Images/indian-map.png" alt="canada-branch" className="w-full rounded-full" />
                </div>
            </section>
