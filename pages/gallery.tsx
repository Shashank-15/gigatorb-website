            ...
            <div>
                        ...
                        <div className="container">
                            <div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                                <div className="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                                    <h4 className="!text-white">Message From the<span className='text-primary'> COO's </span>Desk </h4>
                                </div>
                ...
                <div className="container">
                    <div className="flex flex-col gap-7 lg:flex-row">
                        ...
                        <img src="/Images/Employees/Nidhi Pandey.png"  alt="" className="h-full w-full object-cover" />
                        </div>
...
As COO, I am honoured to lead a team of passionate individuals who share these principles and values. Together, we look forward to embarking on new challenges, exploring innovative solutions, and contributing to a brighter future for all.
...
<p className=" lg:text-lg">Sincerely</p>
<h6>

Nidhi Lav Pandey, Founder & COO</h6>
                            ...
                            <div className="mt-4 grid gap-4 rounded-[10px] bg-white p-5 dark:bg-gray-dark sm:grid-cols-3 ltr:lg:-ml-60 rtl:lg:-mr-60 xl:gap-[72px]">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-semibold text-gray lg:text-xl">Clients</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-semibold text-gray lg:text-xl">Members</p>
                                    </div>
                                </div>
                            </div>
                        </div>
